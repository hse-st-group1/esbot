...
A good structure of the AI response helps with understanding the origin of the answer. Provided sources may help with validating given information. Together this process can help critically analyse a topic or question and getting to the right conclusions. 
...
**Reasoning:**  
The value of the ESBot application is the time it allows students to save during studying. The students are focused on understanding and learning a new concept, and therefore have neither the time nor the concentration to spare towards learning how to use the ESBot. Due to this, the UI should be simple and focused, to allow for intuitive operation. This should be aided by the fact that the ESBot only offers limited functionality (explanations, examples, quizzes, exercises).

**Example Interaction:** A new student wants to ask a question to ESBot. The interface should be easily understandable or even familiar from other applications. For example a chat interface like its provided by many messengers.
...
**Reasoning:**
Students are often on a time crunch when studying or are focused on learning or improving their understanding of new concepts. 
The interaction should support students efficiently during this: 
- A helpful response from the ESBot should be achieved with minimal effort on the users side. 
- The response is as effective in supporting the learning process as possible: Content should be formulated comprehensibly and well structured. It should be easy to understand.  
 
**Example:**
A student asks ESBot to clarify or explain a difficult concept. The response is only useful, if it is easier and quicker to understand than the original material (textbook/lecture slides/...). It therefore needs to be formulated and structured well. 
